...
legend('T=       0s','T=   7E4s','T=1.2E5s','T=1.8E5s')
axis([0 1 -0.2 1.0])
...
%smoothfittingC = fit(lambda_C([1:25:end,end]),-f_C([1:25:end,end])*kBT/v,'smoothingspline','SmoothingParam',0.99999);
%smoothfittingS = fit(lambda_S([1:25:end,end]),-f_S([1:25:end,end])*kBT/v,'smoothingspline','SmoothingParam',0.99999);
...
%plot(smoothfittingC,'linewidth',3);
%plot(smoothfittingS,'linewidth',3);
...
legend('T=       0s','T=   6E4s','T=1.2E5s','T=1.8E5s')
axis([0 1 -0.2 1.0])
%set(T1,'interpreter','latex');
